...
if [ ! -d "$INSTALL_DIR" ]; then
    ...
    wget https://raw.githubusercontent.com/Sucurinet/pjt_fie/master/NEW-ULTIMATE-VPS-MX-8.0/Install/zzupdate.default.conf -O /usr/local/vpsmxup/vpsmxup.default.conf  &> /dev/null
	#chmod +x /usr/local/vpsmxup/vpsmxup.default.conf 
	rm -rf /usr/local/vpsmxup/vpsmxup.sh
    wget https://raw.githubusercontent.com/Sucurinet/pjt_fie/master/NEW-ULTIMATE-VPS-MX-8.0/Install/zzupdate.sh -O /usr/local/vpsmxup/vpsmxup.sh &> /dev/null
	chmod +x /usr/local/vpsmxup/vpsmxup.sh
	rm -rf /usr/bin/vpsmxup
    wget https://raw.githubusercontent.com/Sucurinet/pjt_fie/master/NEW-ULTIMATE-VPS-MX-8.0/Install/zzupdate.sh -O /usr/bin/vpsmxup &> /dev/null
